                                                ...
                                                <div class="item">
                                                                ...
                                                                >
                                                                    {
                                                                        ...
                                                                        <div class="item">
                                                                            <img src={atob(itemimg.img_base)} alt={item.estate_title}  style={{minHeight:'230px',maxHeight:'230px',minWidth:'100%',objectFit:'cover'}} />
                                                                        </div>)
                                                                    }
                                                            </OwlCarousel>
                                                        )
                                                    ...
                                                    <div class="content" style={{padding: '1rem'}}>
                                                        ...
                                                        <div class="extra">
                                                            ...
                                                            <NavLink exact to={"/condo/"+item.estate_id} >
